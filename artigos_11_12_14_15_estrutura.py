...
Com textos verbatim em inglês e traduções PT-PT completas
Data: 2026-03-02
Correspondências a completar via pesquisa em @rgbeac, @codigo, @legislacao
"""

ARTICLES_11_12_14_15 = [
    {
        "id": "ART-11",
    ...
    {
        "id": "ART-14",
        "tema": "Necessidades Comportamentais",
        "regulamento": {
    ...
    {
        "id": "ART-15",
        "tema": "Práticas Dolorosas e Mutilações",
        "regulamento": {
...
if __name__ == "__main__":
    print("Artigos 11, 12, 14, 15 - Estrutura com traduções PT-PT")
    print(f"Total de artigos: {len(ARTICLES_11_12_14_15)}")
    for art in ARTICLES_11_12_14_15:
