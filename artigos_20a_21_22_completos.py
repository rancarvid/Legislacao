#!/usr/bin/env python3
"""
Artigos 20a, 21, 22 do Regulamento 2023/0447
Com correspondências completas em @rgbeac, @codigo, @legislacao
Dados verbatim extraídos de documentos originais pelos agentes de exploração
Data: 2026-03-02
"""
...
if __name__ == "__main__":
    import json
    print("Artigos 20a, 21, 22 - Estrutura completa com correspondências")
    print(f"Total de artigos: {len(ARTICLES_20A_21_22)}")
    for art in ARTICLES_20A_21_22:
